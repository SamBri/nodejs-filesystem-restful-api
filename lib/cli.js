...
// Instantiate the clid module exports
var cli = {};
    ...
    if(!err && checkIds && checkIds.length > 0){
      ...
      checkIds.forEach(function(checkId){
        ...
        //  console.log(checkData)
          ...
          // if the user has specified the state or hasn't specified any state, include them accordingly
